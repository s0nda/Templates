...
var Template = (function($) {
	...
	return {
		...
		config_page_head : function (img, portrait=false) {
			...
			*/
			...
			this.config_page_head_animation(scrW);
		 ...
		 * 
		 *======================================================================================================*/
		config_page_head_animation : function (scrW) {
			let img = new Image();
			let imgW, imgH;
			if (scrW < 400) {
				imgW = 200; imgH = 79;
			...
			pHeader.insertBefore(img, pHeader.lastChild);
			//
			// Animation
			//
			...
			function animationHandler () {
				...
				if (marginLeft <= -imgW) {
					...
					marginTop = (marginTop == 0) ? (Math.floor(Math.random() * 100)) : 0;
	...
	// Call-back function
	//
	function (selector /* id, class selector ... */) 
	{ 
		return document.getElementById(selector) || document.querySelectorAll(selector) || null;
	}
);
